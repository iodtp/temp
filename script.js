...
function ofmLoop(delta, player, enemy, world, keys, app, pspawn, espawn) {
    const modelDetails = {'estimators': [{'intercept': [-0.9181073016629241],
                                          'coef': [[0.0,
                                                    0.0,
                                                    0.0,
                                                    0.0,
                                         ...
                                         {'intercept': [-0.4790645611740522],
                                          'coef': [[0.0,
                                                    ...
                                                    0.0,
                                                    0.5760847975862755]]},
                                         {'intercept': [-0.1537254160146133],
                                          'coef': [[0.0,
                                                    0.0,
                                                    0.0,
                                                    0.0,
                                                    0.042327150681543954,
                                                    0.0,
                                                    0.0,
                                                    0.0,
                                                    0.0,
                                                    0.49739097578117375]]},
                                         {'intercept': [-1.115180687210297],
                                          'coef': [[0.0,
                                                    0.0,
                                                    0.0,
                                                    0.0,
    ...
    //x,y,lx,ly,flag
    const inputFeatures = [enemy.playerCollision.m_xf.position.x*40,enemy.playerCollision.m_xf.position.y*40, enemy.playerCollision.m_linearVelocity.x, enemy.playerCollision.m_linearVelocity.y, Number(enemy.hasFlag),
